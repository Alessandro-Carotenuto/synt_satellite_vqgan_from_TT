    ...
    if scheduler is None:
        match config.LEARNING_RATE_MODE:
            ...
            case LRMODE.REDUCEONPLATEAU:
                scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.65, patience=config.PATIENCE_FOR_LRREDUCEONPLATEAU, min_lr=1e-6) # Reduce LR on Plateau
